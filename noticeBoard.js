...
elementSize(venerText, '50%', '100%', 'border-box')
//! 검색창
const searchbar = document.createElement('input')
second.appendChild(searchbar)
elementSize(searchbar, '90%', '50%', 'border-box')
...
elementSize(boardImg, '25%', '100%', 'border-box')
...
elementSize(boardMainText, '75%', '100%', 'border-box')
//! 게시판 제목과 본문 구역
const boardTitle = document.createElement('div')
boardMainText.appendChild(boardTitle)
elementSize(boardTitle, '100%', '25%', 'border-box')
...
elementSize(boardText, '100%', '75%', 'border-box')
